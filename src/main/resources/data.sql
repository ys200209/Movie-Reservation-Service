-- Members
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("lee     ID", "leePa     ssword", "남자", "1998-01-01", "조나단", "010-1212-3434", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("leeID", "leePassword", "남자", "1998-01-01", "조나단", "010-1212-3434", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("patID", "patPassword", "여자", "2000-01-01", "파트리샤", "010-5656-7878", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("kimID", "kimPassword", "남자", "2002-01-01", "김찬영", "010-1357-2468", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("qwrfeq", "qwrfeq", "남자", "1910-10-01", "이신", "010-1010-1010", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("reqw", "$2a$12$XxN07ZjCSK9tk9zSxpOnZOR/hOAISz1cipobKShGK.sLI90eERZLi", "남자", "1910-10-02", "마법사", "010-1012-1012", "VIP", NOW(), NOW(), "ROLE_ADMIN", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("qoddl2", "qoddl2", "여자", "1910-10-03", "김뱅", "010-1013-1013", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("Qkddl3", "Qkddl3", "여자", "1950-10-01", "박빵", "010-1015-1015", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("seojun04", "jun0985", "남자", "2004-06-09", "김서준", "010-5268-9853", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("jiwoo98", "qwerty98", "여자", "1998-05-05", "박지우", "010-5789-5236", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("ddoddo11", "zxcv89", "남자", "2001-04-28", "최도윤", "010-4562-7536", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("id", "$2a$10$kCgn7yRQy9IJrUu7h2Jr8uBXy71XzPQYZtdV5CBPmYX/37lBSyv8m", "남자", "2001-04-28", "박새로일", "010-1472-5836", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
INSERT INTO members(member_id, member_password, gender, birth, name, phone_number, grade, create_at, modify_at, role_name, enable) VALUES ("id2", "$2a$10$wBRDy1UOSL/cn7BGsj90XuC5XbF6v47dHZmb8cWArhuvlQBlC2p.C", "남자", "2023-05-25", "박새로이", "010-1472-5836", "SILVER", NOW(), NOW(), "ROLE_USER", 1);
...
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 2, 4, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 2, 5, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 2, 6, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 2, 7, 'empty');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 2, 8, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 2, 9, 'normal');
...
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 4, 1, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 4, 2, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 4, 3, 'empty');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 4, 4, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 4, 5, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 4, 6, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 4, 7, 'empty');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 4, 8, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 4, 9, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 5, 1, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 5, 2, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 5, 3, 'empty');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 5, 4, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 5, 5, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 5, 6, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 5, 7, 'empty');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 5, 8, 'normal');
INSERT INTO seats(schedules_seq, seat_row, seat_column, status) VALUES(1, 5, 9, 'normal');
